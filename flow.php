...
if ($_REQUEST['step'] == 'add_to_cart')
{
	...
	if ($_COOKIE['one_step_buy'] == 1)
    {
        ...
        $_SESSION['one_step_buy_goods']=$goods->goods_id;
        clear_cart_goods($goods->goods_id);
    }
...
elseif ($_REQUEST['step'] == 'one_cart')
{
	...
	if ($_COOKIE['one_step_buy'] == '1')
    {
		...
		$sql = "SELECT rec_id FROM " . $ecs->table('cart') . 
			" WHERE $sql_where AND rec_type = '" . $flow_type . "' AND goods_id=".$_SESSION['one_step_buy_goods']."";
