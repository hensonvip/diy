...
$price = $_POST['price'] ? filter_var($_POST['price'],FILTER_SANITIZE_STRING) : 0;
$mobile = $_POST['mobile'] ? filter_var($_POST['mobile'],FILTER_SANITIZE_STRING) : '';
$email = $_POST['email'] ? filter_var($_POST['email'],FILTER_SANITIZE_STRING) : '';
$nowtime= gmtime();
