...
if ($_REQUEST['act'] == 'install')
{
    ...
    $sql = "UPDATE " .$GLOBALS['ecs']->table('mobile_shop_config',1). " SET value = '$tpl_name' WHERE code = 'template'";
    $step_one = $db->query($sql, 'SILENT');
    $sql = "UPDATE " .$GLOBALS['ecs']->table('mobile_shop_config',1). " SET value = '$tpl_fg' WHERE code = 'stylename'";
