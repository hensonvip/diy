...
elseif($_REQUEST['act'] == 'update')
{
	...
	$sql = "update ".$GLOBALS['ecs']->table('mobile_menu')." set ".$con." `menu_url`='$menu_url',`menu_name`='$menu_name',`sort`='$sort' where id = '$id'";
...
elseif($_REQUEST['act'] == 'add_menu')
{
	...
	$sql = "insert into ".$GLOBALS['ecs']->table('mobile_menu')."(`menu_name`,`menu_img`,`menu_url`,`sort`) values('$menu_name','$menu_img','$menu_url','$sort')";
	$num = $GLOBALS['db']->query($sql);
	if($num > 0)
	{
