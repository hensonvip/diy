        ...
        success: function(result){//console.log(result);
            ...
            if(result.code == 401){
                ...
                if(result.code == 200){
                    if(quick){
                        //一步购物
                        window.location.href = '/index.php/goods/checkout.html';
                        return false;
                    }
                }
                layer.open({
...
function collectGoods(goods_id){
    ...
    $.ajax({
        type: "get",
        url: "/index.php/Goods/collectGoods.html",
        dataType: 'json',
...
function guanzhu(supplier_id){
    ...
    $.ajax({
        type: "get",
        url: "/index.php/Supplier/guanzhu.html",
        dataType: 'json',
...
function getCode(send_type,sendButton){
    ...
    $.ajax({
        type: "get",
        url: "/index.php/User/getCode.html",
        dataType: 'json',
