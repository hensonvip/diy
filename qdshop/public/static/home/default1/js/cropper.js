  ...
  prototype.initPreview = function () {
    ...
    this.$preview.each(function () {
      ...
      $this.data(CROPPER_PREVIEW, {
        ...
        height: $this.height(),
        original: $this.html()
      }).html('<img src="' + url + '" style="display:block;width:100%;min-width:0!important;min-height:0!important;max-width:none;max-height:none;image-orientation: 0deg!important">');
    });
  };
