...
(function($){
	...
	$.showCategorySelecter = function(catNameObj, catIdObj, zNodes, selectedId, lang_cat_expand_all, lang_cat_collect_all, lang_cat_expand, lang_cat_collect)
	{
		...
		//生成DIV
		var menuHtml = "<div id='"+menuContent_id+"' class='menuContent' style='display: none; position: absolute; background-color: white; border: 1px #ccc solid;border-radius:2px;z-index:99;'>"
		    +"<div style='text-align: center;padding-top:5px;'>"
		    +"<input type='button' id='"+btn_expand_all_id+"' value='"+lang_cat_expand_all+"' class='layui-btn layui-btn-small layui-btn-normal'>"
		    +"<input type='button' id='"+btn_expand_id+"' value='"+lang_cat_expand+"' class='layui-btn layui-btn-small layui-btn-normal'>"
		    +"<input type='button' id='"+btn_collect_id+"' value='"+lang_cat_collect+"' class='layui-btn layui-btn-small layui-btn-normal'>"
		    +"</div>"
		...
		catNameObj.focus(function(){
   			...
   			$("#"+menuContent_id).css({left:"0",width:"300px"}).slideDown("fast");
