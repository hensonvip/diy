...
<div class="form-div">
	<form action="javascript:searchUser()" name="searchForm" class="layui-form">
		...
		<input type="submit" class="layui-btn" value="<?php echo $this->_var['lang']['button_search']; ?>" />
	</form>
</div>
<form method="POST" action="" name="listForm" onsubmit="return confirm_bath()" class="layui-form">
	<!-- start users list -->
...
?>
			...
			<tr>
				<td colspan="2">
					...
					<input type="submit" id="btnSubmit" value="<?php echo $this->_var['lang']['button_remove']; ?>" class="layui-btn" />
				</td>
