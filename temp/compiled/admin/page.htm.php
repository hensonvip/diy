      ...
      <div id="turn-page">
        ...
        <?php echo $this->_var['lang']['page_size']; ?> <input type='text' size='3' id='pageSize' value="<?php echo $this->_var['filter']['page_size']; ?>" style="width:35px;text-align: center;" onkeypress="return listTable.changePageSize(event)" />
        <span id="page-link">
        ...
        <!--   <select id="gotoPage" onchange="listTable.gotoPage(this.value)">
         ...
         跳转到 <input id="pageInput" title="按回车键跳转到指定页数" value="<?php echo $this->_var['filter']['page']; ?>" style="width:35px;text-align: center;"  onkeypress="if(event.keyCode==13) {listTable.gotoPage(this.value);}"   type="text" onkeydown="if(event.keyCode==13){return false;}">
          <input class="button layui-btn" style="padding:0 18px;height:38px;" id="pagerBtn" value="GO" onclick="goToPage()" type="button">
        </span>
      </div>
<script>
function goToPage(){
