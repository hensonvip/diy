...
a{font-family:"微软雅黑";}
#logo-div {
    height:100px;   float: left;background:#3a8eff;
}

#admininfo-div{height:100px; line-height:100px; width:250px; float:left;}
...
#submenu-div li {
float: right; text-align:center; height:68px; padding:15px; /*background:url(images/top_line.gif) no-repeat left top;*/
}
#submenu-div li a{
...
#submenu-div li.show_10 a:hover{
...
#menu-div li.midd_21 {
	background:url(images/midd.png) no-repeat;background-position:10px 13px;  text-indent:12px;
...
#tabbar-div {
  background:#E6E6E6; font-family:"微软雅黑";
width:240px; height:45px; float:left; line-height:45px; color:#5f5f5f; font-size:14px; font-weight:bold; text-indent:18px;
}
...
<div id="logo-div"><img src="images/logo.png" alt="" /></div>
...
<li class="show_7"><a href="http://www.hunuo.com/"  target="_blank"><?php echo $this->_var['lang']['about']; ?></a></li>
<li class="show_10"><a href="mobile_shop_config.php?act=list_edit" target="main_frame"><?php echo $this->_var['lang']['mobile_shop_config']; ?></a></li>
<li class="show_11"><a href="shop_config.php?act=list_edit" target="main_frame"><?php echo $this->_var['lang']['pc_shop_config']; ?></a></li>
...
<li class="show_4"><a href="javascript:;" onclick="clear_cache()" target="main_frame"><?php echo $this->_var['lang']['clear_cache']; ?></a></li>
