...
<div class="form-div">
  <form name="TimeInterval" action="user_account_manage.php" method="post" style="margin:0px">
    ...
    <input name="start_date" type="text" id="start_date" size="15" value='<?php echo $this->_var['start_date']; ?>' readonly="readonly" class="layui-input"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" />
    <?php echo $this->_var['lang']['end_date']; ?>&nbsp;
    <input name="end_date" type="text" id="end_date" size="15" value='<?php echo $this->_var['end_date']; ?>' readonly="readonly" class="layui-input"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" />
    <input type="submit" name="submit" value="<?php echo $this->_var['lang']['query']; ?>" class="layui-btn" />
  </form>
</div>
<!-- start charger  -->
<div class="list-div">
...
<table cellspacing='1' cellpadding='3' class="layui-table">
  ...
  <tr>
    ...
    <td width="30%" colspan="3"><strong><?php echo $this->_var['account']['surplus']; ?></strong></td>
