...
<div class="form-div" style="height:50px;line-height:50px;">
<form method="post" action="account_log.php?act=list&user_id=<?php echo $_GET['user_id']; ?>" name="searchForm" class="layui-form">
...
<form method="post" action="" name="listForm" class="layui-table">
