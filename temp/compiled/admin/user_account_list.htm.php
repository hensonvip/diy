...
<div class="form-div" style="height:48px;">
  <form action="javascript:searchUser()" name="searchForm" class="layui-form">
    <span style="float:left;">
        ...
        <?php echo $this->_var['lang']['user_id']; ?> 
...
<table cellpadding="3" cellspacing="1" class="layui-table">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('poundage', 'DESC'); ">手续费</a><?php echo $this->_var['sort_poundage']; ?></th>
...
?>
  <tr>
    ...
    <td align="right"><?php echo $this->_var['item']['poundage']; ?></td>
