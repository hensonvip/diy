...
.article_menu LI.button A {
	BACKGROUND: #17232c no-repeat center 44px;
	DISPLAY: block;
	FONT-SIZE: 14px;
	OVERFLOW: hidden;
	WIDTH: 100%;
...
.article_menu LI.button a em#h1_01_mobile_setting {
background-position:18px -633px;
}
...
.dropdown LI a:link{color:#9c9da0 !important;}
.dropdown LI::before {
	bottom: 0;
	content: "";
	left: 0;
