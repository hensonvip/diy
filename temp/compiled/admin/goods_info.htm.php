		...
		<div class="layui-tab-item layui-show">
			...
			<div class="layui-form-item layui-form-text" id="goods_textarea_box">
			    ...
			    <div class="layui-input-initial">
			      <textarea class="layui-textarea" name="goods_design" id="goods_design"><?php echo htmlspecialchars($this->_var['goods']['goods_design']); ?></textarea>
			    </div>
			</div>
			<!--商品货号-->
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					...
					<a href="javascript:void(0)" onclick="rapidCatAdd()" title="<?php echo $this->_var['lang']['rapid_add_cat']; ?>" class="layui-btn layui-btn-normal" style="color:#fff;"><?php echo $this->_var['lang']['rapid_add_cat']; ?></a>
					<span id="category_add" style="display:none;">
						<input class="layui-input" name="addedCategoryName" />
						<a href="javascript:void(0)" onclick="addCategory()" title="<?php echo $this->_var['lang']['button_submit']; ?>" class="layui-btn layui-btn-normal" style="color:#fff;"><?php echo $this->_var['lang']['button_submit']; ?></a>
						<a href="javascript:void(0)" onclick="return goCatPage()" title="<?php echo $this->_var['lang']['category_manage']; ?>" class="layui-btn layui-btn-normal" style="color:#fff;"><?php echo $this->_var['lang']['category_manage']; ?></a>
						<a href="javascript:void(0)" onclick="hideCatDiv()" title="<?php echo $this->_var['lang']['hide']; ?>" class="layui-btn layui-btn-normal" style="color:#fff;">&lt;&lt;</a>
					</span>
					<?php endif; ?>
			...
			<div class="layui-form-item" id="cat_add_select">
				<label class="layui-form-label"><?php echo $this->_var['lang']['lab_other_cat']; ?></label>
...
?>
			      	...
			      	<select name="other_cat[]" onchange="hideCatDiv()" class="layui-input" ><option value="0"><?php echo $this->_var['lang']['select_please']; ?></option><?php echo $this->_var['cat_other_list']; ?></select>
			      	<input type="button" value="<?php echo $this->_var['lang']['add']; ?>" onclick="addOtherCat(this.parentNode)" class="layui-btn layui-btn-normal" style="margin-left:5px;" />
			    </div>
			</div>
			<!--商品品牌-->
			<div class="layui-form-item">
			    ...
			    <div class="layui-input-block">
			    	<input class="layui-input" id="brand_search" name="brand_search" type="text" value="<?php echo empty($this->_var['brand_name_val']) ? '请输入……' : $this->_var['brand_name_val']; ?>" onclick="onC_search()" onblur="onB_search()" oninput="onK_search(this.value)" />
					...
					<?php if ($this->_var['is_add']): ?>
					<a href="javascript:void(0)" title="<?php echo $this->_var['lang']['rapid_add_brand']; ?>" onclick="rapidBrandAdd()" class="layui-btn layui-btn-normal" style="color:#fff;"><?php echo $this->_var['lang']['rapid_add_brand']; ?></a>
					<span id="brand_add" style="display:none;">
						<input class="layui-input" name="addedBrandName" />
						<a href="javascript:void(0)" onclick="addBrand()" class="layui-btn layui-btn-normal" style="color:#fff;"><?php echo $this->_var['lang']['button_submit']; ?></a>
						<a href="javascript:void(0)" onclick="return goBrandPage()" title="<?php echo $this->_var['lang']['brand_manage']; ?>" class="layui-btn layui-btn-normal" style="color:#fff;"><?php echo $this->_var['lang']['brand_manage']; ?></a>
						<a href="javascript:void(0)" onclick="hideBrandDiv()" title="<?php echo $this->_var['lang']['hide']; ?>" class="layui-btn layui-btn-normal" style="color:#fff;">&lt;&lt;</a>
					</span>
					<?php endif; ?>
							...
							<table width="500" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									<td valign="top" style="padding-left:10px">
										<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_49718200_1531448159');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_49718200_1531448159']):
?> -->
										<!-- <?php if ($this->_var['brand_list_0_49718200_1531448159']['name_p'] >= "a" && $this->_var['brand_list_0_49718200_1531448159']['name_p'] <= "g"): ?> -->
										<div id="@<?php echo $this->_var['key']; ?>">
											<div id="<?php echo $this->_var['brand_list_0_49718200_1531448159']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_49718200_1531448159']['name']; ?>">
												<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_49718200_1531448159']['name']; ?>')"><?php echo $this->_var['brand_list_0_49718200_1531448159']['name']; ?></a>
											</div>
										</div>
										<!-- <?php endif; ?> -->
										<!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
									...
									<td valign="top" style="padding-left:10px">
										<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_49727900_1531448159');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_49727900_1531448159']):
?> -->
										<!-- <?php if ($this->_var['brand_list_0_49727900_1531448159']['name_p'] >= "h" && $this->_var['brand_list_0_49727900_1531448159']['name_p'] <= "k"): ?> -->
										<div id="@<?php echo $this->_var['key']; ?>">
											<div id="<?php echo $this->_var['brand_list_0_49727900_1531448159']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_49727900_1531448159']['name']; ?>">
												<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_49727900_1531448159']['name']; ?>')"><?php echo $this->_var['brand_list_0_49727900_1531448159']['name']; ?></a>
											</div>
										</div>
										<!-- <?php endif; ?> -->
										<!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
									...
									<td valign="top" style="padding-left:10px">
										<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_49736700_1531448159');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_49736700_1531448159']):
?> -->
										<!-- <?php if ($this->_var['brand_list_0_49736700_1531448159']['name_p'] >= "l" && $this->_var['brand_list_0_49736700_1531448159']['name_p'] <= "s"): ?> -->
										<div id="@<?php echo $this->_var['key']; ?>">
											<div id="<?php echo $this->_var['brand_list_0_49736700_1531448159']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_49736700_1531448159']['name']; ?>">
												<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_49736700_1531448159']['name']; ?>')"><?php echo $this->_var['brand_list_0_49736700_1531448159']['name']; ?></a>
											</div>
										</div>
										<!-- <?php endif; ?> -->
										<!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
									...
									<td valign="top" style="padding-left:10px">
										<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_49745400_1531448159');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_49745400_1531448159']):
?> -->
										<!-- <?php if ($this->_var['brand_list_0_49745400_1531448159']['name_p'] >= "t" && $this->_var['brand_list_0_49745400_1531448159']['name_p'] <= "z"): ?> -->
										<div id="@<?php echo $this->_var['key']; ?>">
											<div id="<?php echo $this->_var['brand_list_0_49745400_1531448159']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_49745400_1531448159']['name']; ?>">
												<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_49745400_1531448159']['name']; ?>')"><?php echo $this->_var['brand_list_0_49745400_1531448159']['name']; ?></a>
											</div>
										</div>
										<!-- <?php endif; ?> -->
										<!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
									...
									<td valign="top" style="padding-left:10px">
										<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_49754200_1531448159');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_49754200_1531448159']):
?> -->
										<!-- <?php if ($this->_var['brand_list_0_49754200_1531448159']['name_p'] >= "0" && $this->_var['brand_list_0_49754200_1531448159']['name_p'] <= "9"): ?> -->
										<div id="@<?php echo $this->_var['key']; ?>">
											<div id="<?php echo $this->_var['brand_list_0_49754200_1531448159']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_49754200_1531448159']['name']; ?>">
												<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_49754200_1531448159']['name']; ?>')"><?php echo $this->_var['brand_list_0_49754200_1531448159']['name']; ?></a>
											</div>
										</div>
										<!-- <?php endif; ?> -->
										<!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
			...
			<div class="layui-form-item">
				<label class="layui-form-label"><?php echo $this->_var['lang']['label_suppliers']; ?></label>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" class="layui-input" name="shop_price" value="<?php echo $this->_var['goods']['shop_price']; ?>" size="20" onblur="priceSetted()" onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" />
			...
			<div class="layui-form-item" >
				...
				<div class="layui-input-block">
					<td><input type="text" class="layui-input" name="exclusive" value="<?php echo $this->_var['goods']['exclusive']; ?>" size="20" onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" />
...
?>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" class="layui-input" name="market_price" value="<?php echo $this->_var['goods']['market_price']; ?>" size="20" onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" />
			...
			<div class="layui-form-item" id="promote_box">
				...
				<div class="layui-input-block">
					<input type="text" class="layui-input" id="promote_1" name="promote_price" value="<?php echo $this->_var['goods']['promote_price']; ?>" size="20" onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" />
			...
			<div class="layui-form-item" id="promote_box">
				...
				<div class="layui-input-block">
					<input type="text" class="layui-input" id="buymax" name="buymax" value="<?php echo $this->_var['goods']['buymax']; ?>" size="20" <?php if ($this->_var['goods']['is_buy'] == 0): ?> disabled="disabled" <?php endif; ?> onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')"/>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" class="layui-input" id="cost_price" name="cost_price" value="<?php echo $this->_var['goods']['cost_price']; ?>" size="20" onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" />
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					...
					<?php if (! $this->_var['goods']['goods_img']): ?><img src="images/no.gif" /><?php endif; ?>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					...
					<?php if (! $this->_var['goods']['goods_thumb']): ?><img src="images/no.gif" /><?php endif; ?>
			...
			<div class="layui-form-item">
				<label class="layui-form-label">
					<a href="javascript:showNotice2('noticDesignImg');" title="<?php echo $this->_var['lang']['form_notice']; ?>">
						<img src="images/notice.gif" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>">
					</a>
					上传商品设计图
				</label>
				<div class="layui-input-block">
					...
					<?php if (! $this->_var['goods']['design_img']): ?><img src="images/no.gif" /><?php endif; ?>
					<span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:initial" <?php else: ?> style="display:none" <?php endif; ?> id="noticDesignImg">可以填写外部图片链接，也可以自己上传图片显示。</span>
					<?php if ($this->_var['goods']['design_img']): ?>
						<br/><br/><a href="goods.php?act=show_image&img_url=<?php echo $this->_var['goods']['design_img']; ?>" target="_blank">
							<img src="../<?php echo $this->_var['goods']['design_img']; ?>" border="0" style="max-height:100px;margin-left:10px;" />
						</a>
					<?php endif; ?>
				</div>
			</div>
			...
			<div class="layui-form-item" style="display:none">
				...
				<div class="layui-input-block">
					<input type="checkbox" name="is_catindex" value="1" <?php if ($this->_var['goods']['is_catindex']): ?>checked="checked" <?php endif; ?>  lay-skin="switch" lay-filter="is_catindex" lay-text="是|否" class="layui-input"/>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="radio" name="supplier_status" value="1" <?php if ($this->_var['goods']['supplier_status'] == '1'): ?>checked=checked<?php endif; ?> title="审核通过">
					<input type="radio" name="supplier_status" value="0" <?php if ($this->_var['goods']['supplier_status'] == '0'): ?>checked=checked<?php endif; ?> title="未审核">
					<input type="radio" name="supplier_status" value="-1" <?php if ($this->_var['goods']['supplier_status'] == '-1'): ?>checked=checked<?php endif; ?> title="审核未通过">
				</div>
			</div>
			<div class="layui-form-item">
			    <label class="layui-form-label">审核消息</label>
			    <div class="layui-input-block">
			    	<input class="layui-input" type="text" placeholder="请输入内容" autocomplete="off" name="supplier_status_txt" value="<?php echo $this->_var['goods']['supplier_status_txt']; ?>" style="width:80%;">
			    </div>
			</div>
			<!--<?php endif; ?>-->
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="radio" name="goods_status" value="4" <?php if ($this->_var['goods']['goods_status'] == '4'): ?>checked=checked<?php endif; ?> title="审核通过">
					<!-- <input type="radio" name="goods_status" value="2" <?php if ($this->_var['goods']['goods_status'] == '2'): ?>checked=checked<?php endif; ?> title="未审核"> -->
					<input type="radio" name="goods_status" value="3" <?php if ($this->_var['goods']['goods_status'] == '3'): ?>checked=checked<?php endif; ?> title="审核未通过">
				</div>
			</div>
		</div>
		...
		<div class="layui-tab-item">
			...
			<?php if ($this->_var['cfg']['use_storage']): ?>
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						...
						<input type="text" class="layui-input" name="goods_number" value="<?php echo $this->_var['goods']['goods_number']; ?>" size="20" />
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input" name="goods_total" value="<?php echo $this->_var['goods']['goods_total']; ?>" size="20" />
					</div>
				</div>
				<div class="layui-form-item" >
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" class="layui-input" size="40" value="<?php echo $this->_var['lang']['lab_picture_url']; ?>" style="color:#aaa;" onfocus="if (this.value == '精品图片外部URL'){this.value='http://';this.style.color='#000';}" name="best_img_url" />
					<input type="file" name="best_img"/>
					<?php if (! $this->_var['goods']['best_img']): ?><img src="images/no.gif" /><?php endif; ?>
					<span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:initial" <?php else: ?> style="display:none" <?php endif; ?> id="noticPicture">图片尺寸比例为1:1（正方形），可以填写外部图片链接，也可以自己上传图片显示。</span>
					<?php if ($this->_var['goods']['best_img']): ?>
						<br/><br/><a href="goods.php?act=show_image&img_url=<?php echo $this->_var['goods']['best_img']; ?>" target="_blank">
							<img src="../<?php echo $this->_var['goods']['best_img']; ?>" border="0" style="max-height:100px;margin-left:10px;" />
						</a>
					<?php endif; ?>
				</div>
			</div>
	    ...
	    <div class="layui-tab-item">
			<div class="layui-form-item">
			    ...
			    <div class="layui-input-block">
					...
					<span style="margin-left:10px;line-height:35px;" class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:initial" <?php else: ?> style="display:none" <?php endif; ?> id="noticeGoodsType"><!-- <?php echo $this->_var['lang']['notice_goods_type']; ?> -->选择好商品类型相关属性 - 商品列表 - 在右侧操作栏 - 货品列表 - 添加搭配属性及库存即可</span>
			    </div>
...
?>
		...
		<div class="button-div" style="margin-top:15px;">
			...
			<input id="goods_info_submit" type="submit" value="<?php echo $this->_var['lang']['button_submit']; ?>" class="layui-btn" />
			<input id="goods_info_reset" type="reset" value="<?php echo $this->_var['lang']['button_reset']; ?>" class="layui-btn layui-btn-primary" />
		</div>
