...
<div class="tab-div">
  ...
  <table cellspacing='1' cellpadding='3' id='list-table' width="70%" class="layui-table">
    <tr>
...
?>
  ...
  <table cellspacing="0">
    <tr>
      <td>
        <input name="add" type="submit" id="btnSubmit" value="<?php echo $this->_var['action_link_special']['text']; ?>" onclick="location.href='<?php echo $this->_var['action_link_special']['href']; ?>';" class="layui-btn"/>
      </td>
    </tr>
  </table>
  </div>
