...
<div class="form-div">
  <form action="javascript:searchGoods()" name="searchForm" class="layui-form">
    ...
    <?php $_from = $this->_var['city']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'city_0_53816800_1513334835');if (count($_from)):
    foreach ($_from AS $this->_var['city_0_53816800_1513334835']):
?>
      <?php if ($this->_var['selectKey']['city'] == $this->_var['city_0_53816800_1513334835']['city']): ?>
       <option value="<?php echo $this->_var['city_0_53816800_1513334835']['city']; ?>" selected="selected"><?php echo $this->_var['city_0_53816800_1513334835']['region_name']; ?></option>
      <?php else: ?>
      <option value="<?php echo $this->_var['city_0_53816800_1513334835']['city']; ?>"><?php echo $this->_var['city_0_53816800_1513334835']['region_name']; ?></option>
      <?php endif; ?>
