 ...
 <!--   <select id="gotoPage" onchange="listTable.gotoPage(this.value)">
         ...
         跳转到 <input id="pageInput" title="按回车键跳转到指定页数" value="<?php echo $this->_var['filter']['page']; ?>" style="width:35px;text-align: center;"  onkeypress="if(event.keyCode==13) {listTable.gotoPage(this.value);}"   type="text">
