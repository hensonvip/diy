...
<div class="form-div">
  <form action="javascript:get_search_order()" id="searchForm" name="searchForm">
    ...
    <input type="button" value="<?php echo $this->_var['lang']['button_search']; ?>" class="layui-btn" onclick="get_search_order()" />
	<?php if ($this->_var['is_pre_sale'] != '1'): ?>
	<?php if ($this->_var['is_goods_trash'] != '1'): ?>
	<input type="button" value="批量导出" class="layui-btn" onclick="get_excel()" />
