		  ...
		  <?php echo $this->_var['lang']['require_field']; ?>
                  ...
                  <tr>
                      ...
                      <td id="area" class="goods_select_area">
                         ...
                         <?php $_from = $this->_var['district']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'district_0_46945000_1513334840');if (count($_from)):
    foreach ($_from AS $this->_var['district_0_46945000_1513334840']):
?>
                            <span><?php echo $this->_var['district_0_46945000_1513334840']['district_name']; ?>&nbsp;&nbsp;<a href=javascript:del_district_id(<?php echo $this->_var['district_0_46945000_1513334840']['district_id']; ?>,'<?php echo $this->_var['district_0_46945000_1513334840']['district_name']; ?>')>x</a></span>
                            <script>
                               strdistrict_name.push("<span><?php echo $this->_var['district_0_46945000_1513334840']['district_name']; ?>&nbsp;&nbsp;<a href=javascript:del_district_id(<?php echo $this->_var['district_0_46945000_1513334840']['district_id']; ?>,'<?php echo $this->_var['district_0_46945000_1513334840']['district_name']; ?>')>x</a></span>");
                            </script>
                  ...
                  <!-- <tr>
                      ...
                      <select name="select_city"  size="8" onchange=getCountyList()>
                          <?php $_from = $this->_var['city']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'city_0_46945000_1513334840');if (count($_from)):
    foreach ($_from AS $this->_var['city_0_46945000_1513334840']):
?>
                          <option value="<?php echo $this->_var['city_0_46945000_1513334840']['city']; ?>"><?php echo $this->_var['city_0_46945000_1513334840']['region_name']; ?></option>
                          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                      </select>
                        <?php echo $this->_var['lang']['require_field']; ?>
...
?>
			...
			<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
              ...
              <iframe  name="attr_upload" src="attr_img_upload.php?goods_id=<?php echo $this->_var['goods']['goods_id']; ?>&goods_attr_id=<?php echo $this->_var['color_list_hunuo_com']['0']['goods_attr_id']; ?>" frameborder=1 scrolling=no width="80%" height="850">
			  </iframe>
