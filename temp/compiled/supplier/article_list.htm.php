...
<form method="POST" action="article.php?act=batch_remove" name="listForm" class="layui-form">
<!-- start cat list -->
...
<div>
  ...
  <input type="submit" value="<?php echo $this->_var['lang']['button_submit']; ?>" id="btnSubmit" name="btnSubmit" class="layui-btn"  style="margin-left:10px;"/>
</div>
</form>
