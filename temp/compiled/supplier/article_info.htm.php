...
<div class="tab-div">
  ...
  <div id="tabbody-div">
    <form  action="article.php" method="post" enctype="multipart/form-data" name="theForm" onsubmit="return validate();" class="layui-form">
    <table width="90%" id="general-table">
      <tr>
        <td class="narrow-label"><?php echo $this->_var['lang']['title']; ?></td>
        <td><input type="text" class="layui-input" name="title" size ="40" maxlength="60" value="<?php echo htmlspecialchars($this->_var['article']['title']); ?>" /><?php echo $this->_var['lang']['require_field']; ?></td>
      </tr>          
      <tr>
      ...
      <tr>
        ...
        <td><input type="text" class="layui-input" name="author" maxlength="60" value="<?php echo htmlspecialchars($this->_var['article']['author']); ?>" /></td>
      </tr>
      <tr>
        <td class="narrow-label"><?php echo $this->_var['lang']['email']; ?></td>
        <td><input type="text" class="layui-input" name="author_email" maxlength="60" value="<?php echo htmlspecialchars($this->_var['article']['author_email']); ?>" /></td>
      </tr>
      <tr>
        <td class="narrow-label"><?php echo $this->_var['lang']['keywords']; ?></td>
        <td><input type="text" class="layui-input" name="keywords" maxlength="60" value="<?php echo htmlspecialchars($this->_var['article']['keywords']); ?>" /></td>
      </tr>
      <tr>
    ...
    <table width="90%" id="goods-table" style="display:none">
      ...
      <td colspan="5">
        ...
        <!-- 关键字 -->
        <input type="text" class="layui-input" name="keyword" size="30" />
...
?>
    ...
    <div class="button-div" style="padding-left:298px;">
