...
#submenu-div li {
float: right;
 width:77px;  text-align:center; height:68px; padding-top:15px; /*background:url(images/top_line.gif) no-repeat left top;*/
}
#submenu-div li a{
...
<div id="logo-div"><img src="images/logo.png" alt="68ECSHOP" /></div>
