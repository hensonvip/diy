...
<form method="post" action="customer.php?act=batch_drop" name="listForm" onsubmit="return confirm('<?php echo $this->_var['lang']['batch_drop_confirm']; ?>');" class="layui-form">
	<!-- start pre_sale list -->
...
?>
		...
		<table cellpadding="4" cellspacing="0">
			<tr>
				<td>
					<input type="submit" name="drop" id="btnSubmit" value="<?php echo $this->_var['lang']['drop']; ?>" class="layui-btn" />
				</td>
