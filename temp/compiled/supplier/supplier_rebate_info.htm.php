...
<?php endif; ?>
  <table cellpadding="3" cellspacing="1" class="layui-table">
    <tr>
      <th style="text-align:center"><a href="javascript:listTable.sort('sr.add_time'); ">账户变动时间</a></th>
      <th style="text-align:center">订单号</th>
      <th style="text-align:center">订单金额（元）</th>
      <th style="text-align:center">平台扣除佣金（元）</th>
	  <th style="text-align:center">商家实际收入金额（元）</th>
