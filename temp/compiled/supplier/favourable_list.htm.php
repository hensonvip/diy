...
<form method="post" action="favourable.php" name="listForm" onsubmit="return confirm(batch_drop_confirm);" class="layui-form">
...
?>
  ...
  <table cellpadding="4" cellspacing="0">
    <tr>
      <td><input type="submit" name="drop" id="btnSubmit" value="<?php echo $this->_var['lang']['drop']; ?>" class="layui-btn" />
