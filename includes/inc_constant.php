...
/* 综合状态(可执行操作) */
define('CAN_NOT',  0); // 无操作
define('CAN_PAY', 1); // 可支付
define('CAN_CANCEL',  2); // 可取消
define('CAN_REFUND',  3); // 可退款
define('CAN_RETURN',  4); // 可退货
define('CAN_RECEIVED',5); // 可确认收货
define('CAN_COMMENT', 6); // 可评论
define('CAN_SHAIDAN', 7); // 可晒单
...
/* 商品状态 */
define('GS_DEFAULT',            0); // 后台添加的商品
define('GS_UNSOLD',             1); // DIY商品未出售状态
define('GS_CHECKED',            2); // DIY商品申请出售审核中状态
define('GS_UNPASS',             3); // DIY商品审核不通过状态
define('GS_PASS',               4); // DIY商品审核通过已出售状态

// 参赛记录状态
define('ORY_RED_UN',            0); // 参赛待审核
define('ORY_RED_NOPASS',        1); // 参赛未通过
define('ORY_RED_PASS',        	2); // 参赛已通过

// 用户关注状态
define('USER_ATTENTION_NO',      0); // 未关注用户
define('USER_ATTENTION',         1); // 单向关注用户
define('USER_ATTENTION_BOTH',    2); // 互相关注用户

// 赛期状态
define('ORY_COLLECT',      1); // 参赛期
define('ORY_VOTE',         2); // 投票期
define('ORY_PUBLICITY',    3); // 公示期
define('ORY_NOT',    0); // 无赛事
