 ...
 * @return string               上传图片名
 */
function upload_file($upload, $type,$user_id = 0)
{
...
function assign_template($ctype = '', $catlist = array())
{
    ...
    // 设置未读消息数量
    $smarty->assign('mem_message',   get_member_message());
 ...
 * @return  int         数量
 */
function get_member_message()
{

    $sql = "SELECT count(*) FROM " . $GLOBALS['ecs']->table('mem_mess_list') .
            " WHERE mem_id = '" . $_SESSION['user_id'] . "'" .
            " AND readed = 0 ";
