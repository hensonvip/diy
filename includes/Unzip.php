             ...
             while ($zip_entry = zip_read($zip)){
                    ...
                    if (zip_entry_open($zip,$zip_entry,"r")){
                        ...
                        if ($overwrite === true || $overwrite === false && !is_file($file_name)){
                            ...
                            // echo "save: ".iconv('GB2312', 'UTF-8', $file_name)."<br />";
                            // $file_name = ltrim(iconv('GB2312', 'UTF-8', $file_name), './');
                            $res[] = $file_name;
                        }
...
/*$z = new Unzip();
$z->unzip("./PopularTemplate.zip",'./unzipres/', true, false);
$z->deleteAll('./unzipres');*/
