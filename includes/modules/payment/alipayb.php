...
class alipayb {
	...
	public function alipay() {
		...
		$this->gateway = new AopAppGateway();
		$this->gateway->setSignType($alipay['sign_type']); //RSA/RSA2
		$this->gateway->setAppId($alipay['appId']);
		$this->gateway->setPrivateKey($alipay['rsa_private_key']);
		$this->gateway->setAlipayPublicKey($alipay['ali_public_key']);
		$this->gateway->setNotifyUrl('http://' . $_SERVER ['HTTP_HOST'].'/respond.php');
