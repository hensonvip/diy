...
abstract class AbstractAopGateway extends AbstractGateway
{
    ...
    {
       return $this->createRequest(get_class(new AopCompletePurchaseRequest), $parameters);
    }
    ...
    {
        return $this->createRequest(get_class(new AopTradeQueryRequest), $parameters);
    }
    ...
    {
        return $this->createRequest(get_class(new AopTradeRefundRequest), $parameters);
    }
    ...
    {
        return $this->createRequest(get_class(new AopTradeRefundQueryRequest), $parameters);
    }
    ...
    {
        return $this->createRequest(get_class(new AopTradeCloseRequest), $parameters);
    }
    ...
    {
        return $this->createRequest(get_class(new AopTradeCancelRequest), $parameters);
    }
    ...
    {
        return $this->createRequest(get_class(new AopTransferToAccountRequest), $parameters);
    }
    ...
    {
        return $this->createRequest(get_class(new AopTransferToAccountQueryRequest), $parameters);
    }
    ...
    {
        return $this->createRequest(get_class(new AopTradeOrderSettleRequest), $parameters);
    }
    ...
    {
        return $this->createRequest(get_class(new DataServiceBillDownloadUrlQueryRequest), $parameters);
    }
}
