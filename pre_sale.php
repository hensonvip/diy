...
//		$stat = pre_sale_stat($row['act_id'], $ext_info['deposit']);
		...
		$pre_sale['local_end_date'] = local_date('Y, m-1, d, H, i, s', $pre_sale['end_time']-(8*3600));
		$pre_sale['local_start_date'] = local_date('Y, m-1, d, H, i, s', $pre_sale['start_time']-(8*3600));
