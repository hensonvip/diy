...
$_LANG['invalid_best_img'] = '精品图片格式不正确！';
$_LANG['invalid_goods_thumb'] = '商品缩略图格式不正确！';
$_LANG['invalid_img_url'] = '商品相册中第%s个图片格式不正确!';
$_LANG['invalid_design_img'] = '商品设计图片格式不正确！';

$_LANG['goods_img_too_big'] = '商品图片文件太大了（最大值：%s），无法上传。';
$_LANG['best_img_too_big'] = '商品设计图片文件太大了（最大值：%s），无法上传。';
$_LANG['design_img_too_big'] = '精品图片文件太大了（最大值：%s），无法上传。';
