...
/* 权限管理的一级分组 */
$_LANG['goods'] = '商品管理';
$_LANG['font_manage'] = '字体管理';
$_LANG['graph_manage'] = '图形管理';
$_LANG['mask_manage'] = '蒙版管理';
$_LANG['cms_manage'] = '文章管理';
$_LANG['users_manage'] = '会员管理';
$_LANG['report_manage'] = '举报管理';
$_LANG['research_manage'] = '意见反馈管理';
...
$_LANG['check_goods'] = '待审核商品';

// 字体管理部分的权限
$_LANG['font_type'] = '字体分类';
$_LANG['font_list'] = '字体列表';

// 图形管理部分的权限
$_LANG['graph_type'] = '图形分类';
$_LANG['graph_list'] = '图形列表';

// 蒙版管理部分的权限
$_LANG['mask_list'] = '蒙版列表';

// 领域管理部分的权限
$_LANG['field_list'] = '领域列表';

// 私信管理部分的权限
$_LANG['personal_letter'] = '私信列表';

// 举报管理权限
$_LANG['letter_report'] = '私信举报';
$_LANG['goods_report'] = '商品举报';
$_LANG['report_comment'] = '举报评论';
$_LANG['report_reason'] = '私信举报原因';

// 意见反馈
$_LANG['research_list'] = '意见反馈';
...
$_LANG['bank_card_manage'] = '银行卡列表';
$_LANG['bank_manage'] = '银行列表';
...
// 创意擂台
$_LANG['originality_manage'] = '创意比赛';
$_LANG['originality_list'] = '比赛列表';
$_LANG['originality_examine'] = '审核列表';
$_LANG['originality_already'] = '通过列表';
$_LANG['originality_not'] = '未通过列表';
$_LANG['originality_edit'] = '列表编辑';
$_LANG['originality_delete'] = '列表删除';
$_LANG['originality_prize'] = '奖项设置';
$_LANG['originality_test'] = '测试删除';

//手机
$_LANG['mobile_manage'] = '手机版设置';
$_LANG['mobile_menu'] = '自定义菜单';
$_LANG['mad_position'] = '广告位置';
$_LANG['mad_list'] = '广告列表';
