...
$_LANG['log_action']['unreport'] = '取消举报';
...
$_LANG['log_action']['attr_group_img'] = '属性组合图片';
...
$_LANG['log_action']['bank'] = '银行';
$_LANG['log_action']['bargain'] = '砍价';
$_LANG['log_action']['group'] = '拼团';
$_LANG['log_action']['font_type'] = '字体分类';
$_LANG['log_action']['font'] = '字体';
$_LANG['log_action']['graph_type'] = '图形分类';
$_LANG['log_action']['graph'] = '图形';
$_LANG['log_action']['mask'] = '蒙版';
$_LANG['log_action']['field'] = '领域';
$_LANG['log_action']['letter'] = '私信';
$_LANG['log_action']['letter_report'] = '私信';
$_LANG['log_action']['goods_report'] = '商品举报';
$_LANG['log_action']['report_reason'] = '举报原因';
$_LANG['log_action']['research'] = '意见反馈';

$_LANG['log_action']['originality_list'] = '创意比赛';

$_LANG['log_action']['originality_examine'] = '参赛作品审核列表';
$_LANG['log_action']['originality_already'] = '参赛作品通过列表';
$_LANG['log_action']['originality_not'] = '参赛作品未通过列表';
$_LANG['log_action']['originality_prize'] = '奖项设置';
?>