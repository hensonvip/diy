...
$_LANG['use_time'] = '使用时间';
$_LANG['is_paid'] = '状态';
$_LANG['is_confirm'] = '已转账';
$_LANG['un_confirm'] = '待转账';
$_LANG['pay'] = '付款';
$_LANG['is_cancel'] = '取消';
...
//银行卡
$_LANG['bank_card_list'] = '银行卡列表';
$_LANG['add_bank_card'] = '添加银行卡';
$_LANG['card_name'] = '开户银行卡名称';
$_LANG['card_number'] = '银行卡号';
$_LANG['bank_list_success'] = '添加银行卡成功';
$_LANG['back_bank_list'] = '返回银行卡列表';
