...
class FileCacheController
{
    ...
    public function __construct($options = array())
    {
        ...
        $this->options['temp']   = !empty($options['temp']) ? $options['temp'] : dirname(dirname(dirname(__FILE__))).'/temp/session_caches/';
        $this->options['prefix'] = isset($options['prefix']) ? $options['prefix'] : 'hunuo_';
