...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    $goods_type['edit_area_x']    = trim($_POST['edit_area_x']);
    $goods_type['edit_area_y']    = trim($_POST['edit_area_y']);
    $goods_type['edit_area_w']    = trim($_POST['edit_area_w']);
    $goods_type['edit_area_h']    = trim($_POST['edit_area_h']);
