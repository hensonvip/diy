...
if ($_REQUEST['act'] == 'insert')
{
    ...
    $flashimg['href_url'] = !empty($_POST['href_url']) ? filter_var($_POST['href_url'],FILTER_SANITIZE_STRING) : '';
	/*处理图片*/
    $img_url = filter_var_array($_FILES['img_url'], FILTER_SANITIZE_SPECIAL_CHARS); 
    $flashimg['img_url']  = basename($image->upload_image($img_url,'catflashimg'));
	/*处理URL*/
    $flashimg['href_url']= sanitize_url( $flashimg['href_url'] );
	$flashimg['img_title'] = !empty($_POST['img_title']) ? filter_var($_POST['img_title'],FILTER_SANITIZE_STRING) : '';
	$flashimg['img_desc'] = !empty($_POST['img_desc']) ? filter_var($_POST['img_desc'],FILTER_SANITIZE_STRING) : '';
...
if ($_REQUEST['act'] == 'update')
{
    ...
    $img['href_url'] = !empty($_POST['href_url']) ? filter_var($_POST['href_url'],FILTER_SANITIZE_STRING) : '';
	$img['img_title'] = !empty($_POST['img_title']) ? filter_var($_POST['img_title'],FILTER_SANITIZE_STRING) : '';
	$img['img_desc'] = !empty($_POST['img_desc']) ? filter_var($_POST['img_desc'],FILTER_SANITIZE_STRING) : '';

	if ($_FILES['img_url']['tmp_name'] != '' && $_FILES['img_url']['tmp_name'] != 'none')
	{
        $img_url = filter_var_array($_FILES['img_url'], FILTER_SANITIZE_SPECIAL_CHARS); 
		$img['img_url'] = basename($image->upload_image($img_url,'catflashimg'));
