...
$name = filter_var($_FILES['Filedata']['name'],FILTER_SANITIZE_STRING);
$img_name = $dir . $img_name . $GLOBALS['image']->get_filetype($name);
$tmp_name = filter_var($_FILES['Filedata']['tmp_name'],FILTER_SANITIZE_STRING);
move_upload_file($tmp_name, $img_name);
